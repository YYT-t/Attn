import os
from transformers import AutoTokenizer, Trainer, TrainingArguments, AutoModelForCausalLM, LlamaConfig, LlamaForCausalLM
...
if Args.if_test=="y" or Args.if_probe=="y" or Args.if_plot=="y" or Args.if_attn_text=="y":
